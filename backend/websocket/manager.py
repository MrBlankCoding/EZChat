        ...
        while True:
            ...
            try:
                ...
                if message_type == WebSocketMessageType.MESSAGE:
                    ...
                    message_dict = message_obj.dict(exclude={"from_user", "to_user"})
                    message_dict.update(
                        {
                            "sender_id": from_user,
                    ...
                    recipient_received = await connection_manager.send_personal_message(
                        message_obj, to_user
                    )

                    # If recipient received the message, update status to delivered
                    if recipient_received:
                        ...
                        await websocket.send_text(delivery_receipt.json())
